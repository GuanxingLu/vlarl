#!/bin/bash
# Usage: bash scripts/train_grpo_vllm_ray_fsdp_mini.sh <gpus> <task_ids>
# Example: bash scripts/train_grpo_vllm_ray_fsdp_mini.sh 0,1 0,0,1,1
# Explanation:
# num_groups = local_rollout_batch_size // number_envs_per_task_id
# ================================
...
echo "number_envs_per_task_id=${number_envs_per_task_id}"

CUDA_VISIBLE_DEVICES=$GPUS python \
    grpo_vllm_thread_ray_fsdp_vla_v3.py \
    ...
    --number_envs_per_task_id ${number_envs_per_task_id} \
